...
```json
"require": {
    "roseo/cielo-api-3.0-php": "dev-main"
}
```
...
```
composer require "roseo/cielo-api-3.0-php"
```
...
| ---------------- | ---------------------- | --------------- | ---------------------- | ------ | ------- |
| Visa             | CreditCard::VISA       | Sim             | Sim                    | Sim    | _Não_   |
| Master Card      | CreditCard::MASTERCARD | Sim             | Sim                    | Sim    | _Não_   |
| American Express | CreditCard::AMEX       | Sim             | Sim                    | _Não_  | _Não_   |
| Elo              | CreditCard::ELO        | Sim             | Sim                    | _Não_  | _Não_   |
| Diners Club      | CreditCard::DINERS     | Sim             | Sim                    | _Não_  | _Não_   |
| Discover         | CreditCard::DISCOVER   | Sim             | _Não_                  | _Não_  | _Não_   |
| JCB              | CreditCard::JCB        | Sim             | Sim                    | _Não_  | _Não_   |
| Aura             | CreditCard::AURA       | Sim             | Sim                    | _Não_  | _Não_   |
